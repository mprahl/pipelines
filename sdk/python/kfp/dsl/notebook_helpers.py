...
This module provides a stub for `dsl.run_notebook(**kwargs)`. At runtime inside
`@dsl.notebook_component`, the SDK binds this symbol to a helper that executes
the embedded notebook with the provided parameters.
"""
...
def run_notebook(**kwargs: Any) -> None:
    """Execute the component's embedded Jupyter notebook with injected parameters.
    ...
    provided `**kwargs`, and executes the notebook via nbconvert.
